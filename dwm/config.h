...
static const char *fonts[]          = { "SFMono-Regular:size=10" };
static const char dmenufont[]       = "SFMono-Regular:size=10";
...
static const char col_cyan[]        = "#bf0103";  /* Active tag and window border color */
